...
<body class="home">
    ...
    <div class="container">
        ...
        <div class="home-slide1 owl-carousel nav-style1" data-items="1" data-nav="true" data-dots="false" data-loop="true" data-autoplay="true">
            <img src="Frontend/Assests/images/slides/1.jpg" alt="">
            <img src="Frontend/Assests/images/slides/2.jpg" alt="">
            <img src="Frontend/Assests/images/slides/3.jpg" alt="">
        </div>
        <!-- ./Home slide -->
        <div class="margin-top-40">
            <div class="row">
                <div class="col-sm-4" style="text-align: right;">
                    <img style="margin-right: 20px;" class=" margin-top-25" src="Frontend/Assests/images/logos/1.png" alt="">
                </div>
                <div class="col-sm-7">
        ...
        <div class="margin-top-40">
            <div class="row">
                <div class="col-sm-12 col-md-6 margin-bottom-30">
                    <a class="banner-opacity" href="/shop"><img src="Frontend/Assests/images/b/2.jpg" alt=""></a>
                </div>
                <div class="col-sm-12 col-md-6">
                    <div class="row">
                        <div class="col-sm-6">
                            <a href="/shop" class="banner-product">
                                <img src="Frontend/Assests/images/products/11.jpg" alt="">
                        ...
                        <div class="col-sm-6">
                            <a href="/shop" class="banner-product">
                                <img src="Frontend/Assests/images/products/13.jpg" alt="">
                                <h3 class="text">T-Shirt Weekday Crew Sweatshir</h3>
                                <span class="price">£125.00</span>
                            </a>
                        </div>
                        <div class="col-sm-6">
                            <a href="/shop" class="banner-product">
                                <img src="Frontend/Assests/images/products/27.jpg" alt="">
                                <h3 class="text">T-Shirt Weekday Crew Sweatshir</h3>
                                <span class="price">£125.00</span>
                            </a>
                        </div>
                        <div class="col-sm-6">
                            <a href="/shop" class="banner-product">
                                <img src="Frontend/Assests/images/products/28.jpg" alt="">
                                <h3 class="text">T-Shirt Weekday Crew Sweatshir</h3>
                                <span class="price">£125.00</span>
                            </a>
                        </div>
            ...
            <div class="row">
                <div class="col-sm-12 col-md-6">
                    <div class="row">
                        <div class="col-sm-12">
                            <a href="/shop" class="banner-product">
                                <img src="Frontend/Assests/images/products/17.jpg" alt="">
                                <h3 class="text">T-Shirt Weekday Crew Sweatshir</h3>
                                <span class="price">
                                    <ins>£125.00</ins>
                                    <del>£150.00</del>
                ...
                <div class="col-sm-12 col-md-6">
                    <a class="banner-opacity" href="/shop"><img src="Frontend/Assests/images/b/3.jpg" alt=""></a>
                </div>
            </div>
        </div>
        <div class="margin-top-30 section-lasttest-blog">
            ...
            <div class="lastest-blog owl-carousel nav-center-center nav-style7" data-nav="true" data-dots="false" data-loop="true" data-margin="30" data-responsive='{"0":{"items":1},"600":{"items":1},"1000":{"items":2}}'>
                <div class="item-blog">
                    ...
                    <div class="right">
                        <a class="banner-border" href="#"><img src="Frontend/Assests/images/blogs/1.jpg" alt=""></a>
                    </div>
                </div>
                <div class="item-blog">
                    <div class="left">
                    ...
                    <div class="right">
                        <a class="banner-border" href="#"><img src="Frontend/Assests/images/blogs/2.jpg" alt=""></a>
                    </div>
                </div>
                <div class="item-blog">
                    <div class="left">
        ...
        <div class="section-brand-slide">
            <div class="brands-slide owl-carousel nav-center-center nav-style7" data-nav="true" data-dots="false" data-loop="true" data-margin="60" data-responsive='{"0":{"items":1},"600":{"items":3},"1000":{"items":5}}'>
                <a href="#"><img src="Frontend/Assests/images/brands/brand1.png" alt=""></a>
                <a href="#"><img src="Frontend/Assests/images/brands/brand2.png" alt=""></a>
                <a href="#"><img src="Frontend/Assests/images/brands/brand3.png" alt=""></a>
                <a href="#"><img src="Frontend/Assests/images/brands/brand4.png" alt=""></a>
                <a href="#"><img src="Frontend/Assests/images/brands/brand5.png" alt=""></a>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12 col-md-7">
                    <div class="video video-lightbox">
                        <img src="Frontend/Assests/images/bg_video.png" alt="">
